...
template <class Type>
void linkedStackType<Type>::is_sorted()
{
	if(isEmptyStack())
	{
	...
	while (cur!=NULL)
	{
		if(cur->info >= temp)	Ascending=0 ;
		 if(cur->info <= temp)	Descending=0 ;
		 temp=cur->info ;
		cur = cur->link;
	}
	
	cout<<"Linked Stack is  ";
...
template <class Type>
void linkedStackType<Type>::popElments(int element)
{
    // int element;     
