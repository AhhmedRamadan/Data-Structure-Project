...
template <class Type>
	void  stackType<Type>::print() {									//function for printing
		cout << "[ ";
...
void stackType<Type>::is_sorted()
{
	...
	{
		if(list[i] >= temp)	Ascending=0 ;
		if(list[i] <= temp) Descending=0 ;
		temp=list[i] ;
	}
	
	cout<<"Array Stack is  ";
	if(Ascending && Descending)
		cout<<"Both Ascending & Descending"<<endl ;
	else if(Ascending )
		cout<<"Ascending"<<endl ;
	else if(Descending )
		cout<<"Descending"<<endl ;
	else cout<<"Niether Ascending nor Descending"<<endl ;
...
template <class Type>
void stackType<Type>::popElements(int element)
{
    ...
    if (element <= stackTop)
    {
       ...
       cout << "Cannot remove elements are more than in stack." << endl;
}//end popElments
